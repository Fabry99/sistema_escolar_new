...
while ($fila = $result->fetch_assoc()) {
    ...
    $field2name = $fila['correo'];
    $field3name = $fila['nombre'];
?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="editar">Actualizar Datos de administrador</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form id="updateForm<?php echo $fila['id']; ?>" action="../../administrador/views/actualizarAdmin.php?id=<?= $field0name ?>" method="post">

                        <div class="row">
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    <label for="correo" class="form-label">Correo</label>
                                    <input value="<?= $field2name ?>" name="correo" class="form-control" id="correo<?php echo $fila['id']; ?>">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input value="<?= $field3name ?>" name="nombre" class="form-control" id="nombre<?php echo $fila['id']; ?>">
                                </div>
                            </div>
