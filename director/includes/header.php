...
error_reporting(0);
session_start();
if (!isset($_SESSION['nivel_acceso']) || $_SESSION['nivel_acceso'] !== 'director') {
...
<head>
    ...
    <link href="../../director/css/sb-admin-2.min.css" rel="stylesheet">


    <script src="../../director/js/jquery.min.js"></script>
