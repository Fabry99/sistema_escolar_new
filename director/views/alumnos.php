    ...
    <body id="page-top">
        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                ...
                <?php include "../../director/views/modalAggAlumno.php"; ?>
                <?php include "../../director/views/modalActuaAlumno.php"; ?>
        ...
        function confirmDelete(id, nombre) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = '../../director/views/eliminarAlumno.php?id=' + id;
                }
            });
        }
    </script>
