...
if (isset($_POST['nombre']) && isset($_POST['apellidos']) && isset($_POST['dui']) && isset($_POST['correo']) && isset($_POST['id_estado'])) {
    ...
    if (!is_numeric($id_estado)) {
        ...
        $consulta = "INSERT INTO profesores (nombre, apellidos, dui, correo, id_estado) VALUES ('$nombre', '$apellidos', '$dui', '$correo', $id_estado)";
