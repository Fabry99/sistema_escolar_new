...
<head>
    ...
    <script src="../../profesores/js/jquery.min.js"></script>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item active" style="margin-top: 15px; margin-bottom: 15px;">
            ...
            <!-- Divider -->
            <hr class="sidebar-divider" style="margin-bottom:100px ; ">
            ...
            <li class="nav-item" style="margin-top: 50px;">
                <a class="nav-link collapsed text-light" href="#" data-toggle="modal" data-target="#logoutModal">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-primary topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <?php
                        include "../../profesores/includes/db.php";
